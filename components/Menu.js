...
function DishMedia({ tone }) {
  return (
    <div className={`relative aspect-[5/4] overflow-hidden ${toneMap[tone]}`}>
      <div className="absolute inset-0 bg-grain" />
      <div className="absolute left-1/2 top-1/2 h-24 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full bg-paperLight/90" />
    </div>
  );
}
